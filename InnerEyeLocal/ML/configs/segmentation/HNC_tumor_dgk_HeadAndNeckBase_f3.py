...
class HNC_tumor_dgk_HeadAndNeckBase_f3(HeadAndNeckBase):
    ...
    def get_model_train_test_dataset_splits(self, dataset_df: pd.DataFrame) -> DatasetSplits:
        ...
        '''
        fold = 0 # during training: set to 3
...
# python InnerEyeLocal/ML/runner.py --model=HNC_tumor_dgk_HeadAndNeckBase_f3
